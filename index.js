const apiKey = "7f3933c7a3b46810df8315d433a99fdc";
                ...
                <div class="card-content">
                    <div class="card-header">
                        <div class="left-content">
                            <h3 title="${original_title}" style="font-weight: 600; cursor: pointer;" onclick="getTrailer('${original_title}')">${truncatedTitle}</h3>
